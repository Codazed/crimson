...
async def audio(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    downloader = Downloader(url, context.bot, update.effective_chat.id, True)
    ...
    if os.path.getsize(final_filename) > 50000000:
        ...
        await context.bot.send_audio(chat_id=update.effective_chat.id, audio=open(final_filename, 'rb'))
